...
describe("Checkout Module - Checkout Processing", () => {
  let testUser: any;
  ...
  describe("POST /checkout", () => {
    it("should create pending order without payment", async () => {
      ...
      expect(checkoutNoPayResponse.body.message).toBe(
    ...
    it("should process payment successfully", async () => {
      ...
      expect(checkoutPayResponse.body.message).toBe(
